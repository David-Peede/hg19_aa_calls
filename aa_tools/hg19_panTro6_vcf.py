...
def create_hg19_panTro6_vcf(chrom, buffer_size):
    """
    Writes a VCF file to standard out with the panTro6 ancestral allele for a specified chromosome.  
    """
...
#CHROM\tPOS\tID\tREF\tALT\tQUAL\tFILTER\tINFO\tFORMAT\tpanTro6\n"""
    ...
    skip_set = {'N', '-', '.'}
    # Build the panTro6 alignment dictionary.
    ...
    # For every position.
    for pos in panTro6_aln:
        # Unpack the alleles.
        ref, alt = panTro6_aln[pos]
...
create_hg19_panTro6_vcf(args.chrom, args.buffer_size)